...
pubg_stats <- pubg_stats %>% select(Name = Weapon.Name, Weapon.Type:Fire.Mode) %>% mutate(Single = str_detect(Fire.Mode, "Single"), Automatic = str_detect(Fire.Mode, "Automatic"), Burst = str_detect(Fire.Mode, "Burst")) 
